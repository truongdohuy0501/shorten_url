...
RSpec.describe ShortUrlsController, type: :controller do
  ...
  describe "#create" do
    it do
      ...
      expect(subject.send(:short_urls_params)).to eq({"original_url"=> destination})
  ...
  describe "#shorted" do
    ...
    before { @shortened = ShortUrl.create(original_url: url)}
    it do
      params = {
        shorted_url: @shortened.shorted_url,
      }
